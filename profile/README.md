...
Cette organisation GitHub [regroupe les codes sources des applications développées par l'Abes](#org-profile-repositories). Depuis 2019, l'Abes publie tous ses nouveaux développements en [open source](https://github.com/abes-esr/abes-politique-developpement/blob/main/01-Gestion%20du%20code%20source.md#licences).
...
- [Plugin Koha-AbesWS](https://github.com/abes-esr/Koha-Plugin-AbesWS) : plugin permettant l’utilisation des web services de l’Abes dans le SIBG Koha, à des fins de contrôle qualité (utilisation de bibliocontrol, Algoliens et Qualimarc) et d’enrichissement des informations affichées sur les auteurs dans le catalogue public : bibliographie enrichie et affichage des identifiants idref, ORCID, idhal, viaf, ... Conceptualisé par l’association KohaLa.
